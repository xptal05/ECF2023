...
const tables = [
    ...
    { name: "Hours", id: "hourstbl", headers: ["text"] },
    { name: "Contact", id: "contacttbl", headers: ["text", "category"] },
    { name: "Address", id: "addresstbl", headers: ["TEXT", "CATEGORY"] },
        ...
        btn.addEventListener('click', (e) => {
            ...
            if (selectedItem) {
                if (actionBtn == 'modify') {
                    ...
                    if (tableId == "Services") {
                        serviceInfoPopup(selectedServiceItem, tableId, webInfo[tableId]['array'])
                    }
                ...
                if (tableId == "Services") {
                    serviceInfoPopup(selectedServiceItem, webInfo[tableId]['key'], webInfo[tableId]['array'] )
                }
