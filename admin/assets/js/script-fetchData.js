...
async function fetchAndUpdatePageInfo() {
    try {
        ...
        // Fetch dropdown data from the server
        const phpScriptURLData = './functions/db_query.php?action=fetchData'
        const phpScriptURLImages = './functions/db_query.php?action=fetchData&data=images'
...
async function fetchDataAndRenderList() {
    const phpScriptURL = './functions/db_query.php?action=fetchData'
...
async function fetchDataForDashboard() {
    const phpScriptURL = './functions/db_query.php?action=fetchDataDashbord'
    try {
